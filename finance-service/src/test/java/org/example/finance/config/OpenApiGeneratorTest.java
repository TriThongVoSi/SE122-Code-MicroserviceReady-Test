...
public class OpenApiGeneratorTest {
    ...
    public void generateOpenApiSpec() throws Exception {
        ...
        Files.write(Paths.get("../docs/openapi/finance-service-v1.yaml"), yamlBytes);
        System.out.println("--- OpenAPI YAML spec successfully exported to docs/openapi/finance-service-v1.yaml ---");
    }
}
