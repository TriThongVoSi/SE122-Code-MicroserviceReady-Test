...
@Transactional
@ActiveProfiles("test")
@Sql(scripts = "/sql/auth-schema-compat.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD, config = @SqlConfig(transactionMode = SqlConfig.TransactionMode.ISOLATED))
