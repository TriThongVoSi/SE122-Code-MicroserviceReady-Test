...
import org.example.identity.util.RequestUtils;
import org.example.identity.dto.request.ForgotPasswordRequest;
import org.example.identity.dto.request.ResetPasswordTokenRequest;
import org.example.identity.service.PasswordResetService;
...
public class PasswordResetController {
    ...
    public ApiResponse<Void> forgotPassword(@RequestBody ForgotPasswordRequest request,
        ...
        String ip = RequestUtils.resolveClientIp(httpServletRequest);
